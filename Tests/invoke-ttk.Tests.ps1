...
$invokeScript = "$here\..\arm-ttk-extension-xplatform\powershell\invoke-ttk.psm1"
$exportScript = "$here\..\arm-ttk-extension-xplatform\powershell\Export-NUnitXml.psm1"


Import-Module "$here\..\arm-ttk-extension-xplatform\arm-ttk\arm-ttk.psd1"
Import-Module "$here\..\arm-ttk-extension-xplatform\powershell\Export-NUnitXml.psm1"
Import-Module "$here\..\arm-ttk-extension-xplatform\powershell\invoke-ttk.psm1"
}
...
Describe "File Test" {
    ...
    it "includes an  arm-ttk folder" {
        "$here\..\arm-ttk-extension-xplatform\arm-ttk" | should -Exist
    }
}
